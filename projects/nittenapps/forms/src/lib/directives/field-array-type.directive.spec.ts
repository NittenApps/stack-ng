...
import { createFieldChangesSpy, createFieldComponent, StackInputModule } from '@nittenapps/forms/testing';
...
describe('Array Field Type', () => {
  it('should render fieldGroup', () => {
    ...
    expect(query('nas-form-array')).not.toBeNull();
    expect(queryAll('nas-form-array > nas-field')).toHaveLength(2);
  });
  ...
  it('should ignore invalid model value', () => {
    ...
    expect(queryAll('nas-form-array > nas-field')).toHaveLength(0);
  });
