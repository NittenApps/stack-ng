...
import { createFieldComponent, ɵCustomEvent } from '@nittenapps/forms/testing';
import { StackMatInputModule } from '@nittenapps/material';

const renderComponent = (field: StackFieldConfig) => {
  return createFieldComponent(field, {
    imports: [NoopAnimationsModule, StackMatInputModule],
  });
};
