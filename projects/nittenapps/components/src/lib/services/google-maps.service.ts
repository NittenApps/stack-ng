...
/** Service responsible for loading and reusing the Google Maps SDK. */
...
export class GoogleMapsService {
  ...
  /**
   * Returns the Google Maps API, loading the script only once.
   * @returns Promise with the reference to `google.maps`.
   */
